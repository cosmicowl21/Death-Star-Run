...
bool GameOverScene::init()
{
    ...
    auto backgroundSprite = Sprite::create( "Android/GameOver.png" );
    backgroundSprite->setPosition( Point( visibleSize.width / 2 + origin.x, visibleSize.height / 2 + origin.y ) );
    
    this->addChild( backgroundSprite );
    
    auto retryItem = MenuItemImage::create( "Android/Retry Button.png", "Android/Retry Button Clicked.png", CC_CALLBACK_1( GameOverScene::GoToGameScene, this ) );
    retryItem->setPosition( Point( visibleSize.width / 2 + origin.x, visibleSize.height / 4 * 3 ) );
    
    auto mainMenuItem = MenuItemImage::create( "Android/Menu Button.png", "Android/Menu Button Clicked.png", CC_CALLBACK_1( GameOverScene::GoToMainMenuScene, this ) );
...
void GameOverScene::GoToMainMenuScene( cocos2d::Ref *sender )
{
	...
	Director::getInstance()->replaceScene(TransitionMoveInT::create(TRANSITION_TIME, scene));
}
