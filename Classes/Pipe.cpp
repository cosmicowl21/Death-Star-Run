...
void Pipe::SpawnPipe( cocos2d::Layer *layer )
{
    ...
    auto topPipe = Sprite::create( "Android/Pipe.png" );
    auto bottomPipe = Sprite::create( "Android/Pipe.png" );
    ...
    auto pointBody = PhysicsBody::createBox( Size( 1, Sprite::create( "Android/Player.png" )->getContentSize( ).height * PIPE_GAP ) );
    ...
    pointNode->setPosition( Point( topPipe->getPositionX( ), topPipe->getPositionY( ) - ( topPipe->getContentSize( ).height / 2 ) - ( ( Sprite::create( "Android/Player.png" )->getContentSize( ).height * PIPE_GAP ) / 2 ) ) );
